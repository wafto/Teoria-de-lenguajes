...
int main() {
	...
	std::cout << "******************************************************************" << std::endl;
	std::cout << "* Ejemplos de Polimorfismo con la clase Figura con un Cuadrado   *" << std::endl;
	std::cout << "******************************************************************" << std::endl;
	
	std::cout << "Se crea una nueva clase Cuadrado con referencia Figura(Polimorfismo) y la instanciamos" << std::endl;
